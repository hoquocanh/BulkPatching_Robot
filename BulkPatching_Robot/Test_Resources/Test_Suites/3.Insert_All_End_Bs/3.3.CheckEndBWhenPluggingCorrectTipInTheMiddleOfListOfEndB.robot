...
INSERT_END_B_03_04_Verify that imVision X shall show correctly when any connector in the middle of the End B list is unplugged and showing Delete button in the bottom bar
    #Pre-Condition:
    Given Go To Bulk Patching Screen
    When Plugin Serial Copper Tip to Rack "1" Panel "2" Row "1" from Port "1" to Port "4"    
...
INSERT_END_B_03_05_Verify that imVision X shall show correctly when any connector in the middle of the End B list is unplugged and showing the help text
    #Pre-Condition:
    Given Go To Bulk Patching Screen
    When Plugin Serial Copper Tip to Rack "1" Panel "2" Row "1" from Port "1" to Port "4"    
