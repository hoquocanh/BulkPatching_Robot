...
*** Test Cases ***
Exit_Bulk_04_02_01_Verify that all patches on Bulk patching list are patched successfully after time out if patching on a 24-port Legacy Copper
   #Pre-condition:
    ...
    #Step 1: 
    And Wait For Bulk Patching Timeout
...
Exit_Bulk_04_02_02_Verify that all patches on Bulk patching list are patched successfully after time out if patching on a 48-port Legacy Copper
   #Pre-condition:
    Given Go To Bulk Patching Screen
...
Exit_Bulk_04_02_06_Verify that all patches on Bulk patching list are patched successfully after time out if patching on a LC panel
  #Pre-condition:
    Given Go To Bulk Patching Screen
...
Exit_Bulk_04_02_09_Verify that all patches on Bulk patching list are patched successfully after Time out if patching on a 96LC panel
    #Pre-condition:
    Given Go To Bulk Patching Screen
