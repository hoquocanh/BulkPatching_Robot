...
*** Test Cases ***
Create_Equip-03_01_01_01_Verify that ports on End A that are on the same line as the text "Equipment" on End B should be connected as Equipment connections when End A and End B have the same patches after time out if patching on a 24-port Legacy Copper
    ...
    When Touch Equipment Button
     ...
     #Step 4 :  
     When Wait For Bulk Patching Timeout
...
Create_Equip-03_01_01_02_Verify that ports on End A that are on the same line as the text "Equipment" on End B should be connected as Equipment connections when End A and End B have the same patches after time out if patching on a 48-port Legacy Copper
...
Create_Equip-03_01_01_06_Verify that ports on End A that are on the same line as the text "Equipment" on End B should be connected as Equipment connections when End A and End B have the same patches after time out if patching on a LC panel
...
Create_Equip-03_01_01_08_Verify that ports on End A that are on the same line as the text "Equipment" on End B should be connected as Equipment connections when End A and End B have the same patches after time out if patching on a HDF panel
...
Create_Equip-03_01_01_09_Verify that ports on End A that are on the same line as the text "Equipment" on End B should be connected as Equipment connections when End A and End B have the same patches after time out if patching on a 96LC panel
    ...
    When Touch Equipment Button
     ...
     #Step 3 :  
     When Plugin 24F Tip to Rack "1" Panel "6" Row "1" Module "A" Port "3"
